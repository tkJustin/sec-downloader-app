...
from modules.pdf_converter import PdfConversionError, convert_html_file_to_pdf, verify_pdf_file
        ...
        try:
            ...
            if download_type == "pdf":
                try:
                    ...
                    error = f"HTML and clean text created, but PDF conversion failed: {exc}"
                    pdf_path = Path("")
